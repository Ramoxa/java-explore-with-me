...
public class CompilationPublicController {
    ...
    @GetMapping
    public List<CompilationDto> getCompilationsPublic(HttpServletRequest request, @RequestParam(required = false, name = "pinned") Boolean pinned, @PositiveOrZero @RequestParam(name = "from", defaultValue = "0") Integer from, @Positive @RequestParam(name = "size", defaultValue = "10") Integer size) {
